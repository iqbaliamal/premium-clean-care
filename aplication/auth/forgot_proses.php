                                        ...
                                        <tr>
                                            <td>
                                                <div class="text" style="padding: 0 2.5em; text-align: center;">
                                                    ...
                                                    <p><a href="http://premium-care.workshopjti.com/index.php?page=resetpw&token=' . $token . '&email=' . $email . '&action=reset" class="btn btn-primary">Ubah</a></p>
                                                    <h3>Jika tombol tidak berfungsi klik di sini</h3>
                                                    http://premium-care.workshopjti.com/index.php?page=resetpw&token=' . $token . '&email=' . $email . '&action=reset
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
