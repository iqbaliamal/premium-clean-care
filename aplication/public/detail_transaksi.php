...
<body>
  ...
  <main id="main" class="container mt-4">
    ...
    <ol type="1">
      <li>Treatment pencucian khusus untuk sepatu (lebih dikhususkan sneakers/loafers)
        aman untuk semua bahan dan warna.
      </li>
          ...
          <form action="#" class="form-group login">
            <div class="row">
              <div class="col">
                ...
                <input type="text" name="jumlah_item" id="jenis_layanan" class="form-control" />
                <label for="jumlah_item">Jumlah Item</label>
                <input type="text" name="jumlah_item" id="jumlah_item" class="form-control" />
                <label for="waktu">Tanggal dan Waktu Pick Up</label>
                <input type="datetime-local" name="waktu" id="waktu" class="form-control" />
                <label for="lokasi">Lokasi Pick Up</label>
              ...
              <div class="col">
                ...
                <br>
                <p>setelah klik submit cek email anda, dan pastikan data yang dikirimkan ke email anda sudah benar.
