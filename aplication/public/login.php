...
<body>
  ...
  <section>
  <div class="mt-5">
    <form action="#" class="form-group login border">
      ...
      <a href="register.html" class="ml-2 text-decoration-none text-dark">Register</a><br />
      <a href="lupa_password.html" class="text-decoration-none">Lupa Password?</a>
    </form>
  </div>
</div>
</section><!-- End Hero -->
