        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <button class="editbtn border-0 btn-transition btn btn-outline-warning" type="button"> <i
                    class="fa fa-edit"></i> </button>
                <button class="deletebtn border-0 btn-transition btn btn-outline-danger" type="button"> <i
      ...
      <div class="modal-content">
        ...
        <form action="fungsi/fungsi_order_status.php" method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Nama Status</label>
              <input type="text" name="nama_status" id="orderStatus" class="form-control" placeholder="Nama Status"
                required>
            </div>
